...
- **How many words am I studying?** The **Study** section in Settings shows a **progress bar** under the filters — green for learned, amber for still-to-learn, with a *"X learned · Y to learn · Z total"* label — reflecting your current Levels/Topics selection and updating as you change it. The Session tab's start screen shows how many words are available to start, and the header's *learning / learned* totals (top-right) update live as you answer.
