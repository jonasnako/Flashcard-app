...
- **How many words am I studying?** A **progress bar** — green for learned, amber for still-to-learn, with a *"X learned · Y to learn · Z total"* label — shows your standing under the current study filter. It appears in **Settings → Study** (updating as you change Levels/Topics), on the Session **start** screen ("Ready when you are"), and on the **completion** screen, where the words you just learned this session glow as their own brighter segment. The header's *learning / learned* totals (top-right) also update live as you answer.
